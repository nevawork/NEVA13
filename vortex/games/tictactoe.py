...
class Tictactoe :
    ...
    def make_view_content (self ,*,game_over :bool =False )->discord .ui .Container :
        container =discord .ui .Container (accent_color =None )
        
        container .add_item (discord .ui .TextDisplay ("# ⭕ Tic-Tac-Toe"))
        ...
        if game_over :
            ...
            description =f"**Turn:** {self.turn.mention}\n**Piece:** `{self.player_to_emoji[self.turn]}`"
    ...
    **kwargs ,
        ...
        container =self .make_view_content ()
        container .add_item (discord .ui .Separator ())
        container .add_item (discord .ui .TextDisplay (self .board_string ()))
        ...
        view =discord .ui .LayoutView ()
        container =self .make_view_content (game_over =True )
        container .add_item (discord .ui .Separator ())
        container .add_item (discord .ui .TextDisplay (self .board_string ()))
        view .add_item (container )
        await self .message .edit (view =view )
