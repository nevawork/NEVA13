...
class AntiEveryone (commands .Cog ):
    ...
    def can_message_delete (self ,guild_id ,event_name ,max_requests =3 ,interval =10 ,cooldown_duration =300 ):
        ...
        async with aiosqlite .connect ('db/anti.db')as db :
            ...
            if message .author .bot :
                try :
                    ...
                    await guild .ban (message .author ,reason ="Bot @everyone spam - Instant ban")
                except :
                    pass 
                return 
