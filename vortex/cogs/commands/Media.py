...
class Media (commands .Cog ):
    ...
    async def setup (self ,ctx ,*,channel :discord .TextChannel ):
        ...
        # Title
        container.add_item(ui.TextDisplay("# ✅ Media Channel Setup"))
    ...
    async def remove (self ,ctx ):
        ...
        # Title
        container.add_item(ui.TextDisplay("# ✅ Media Channel Removed"))
        container.add_item(ui.Separator())
    ...
    async def bypass_add (self ,ctx ,user :discord .Member ):
        ...
        # Title
        container.add_item(ui.TextDisplay("# ✅ User Added to Bypass"))
        container.add_item(ui.Separator())
    ...
    async def bypass_remove (self ,ctx ,user :discord .Member ):
        ...
        # Title
        container.add_item(ui.TextDisplay("# ✅ User Removed from Bypass"))
        container.add_item(ui.Separator())
