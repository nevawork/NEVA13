...
class Antinuke (commands .Cog ):
  ...
  async def antinuke (self ,ctx ,option :str =None ):
    ...
    if not is_owner and not check :
      ...
      # Title
      container.add_item(ui.TextDisplay("# ❌ | Access Denied"))
    ...
    if option is None :
      ...
      if is_activated :
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        
        setup_text = ui.TextDisplay("⏳ | Initializing Quick Setup!")
        ...
        if not ctx .guild .me .guild_permissions .administrator :
          ...
          setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
          setup_container.add_item(ui.Separator())
          setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⚠️ | Setup failed: Missing **Administrator** permission."))
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking VORTEXINF-bot's role position for optimal configuration..."))
        await setup_message .edit (view=setup_view)
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking VORTEXINF-bot's role position for optimal configuration...\n⏳ | Crafting and configuring the VORTEXINF Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)

        try :
          role =await ctx .guild .create_role (
          name ="VORTEXINF Unstoppable Power",
          color =0x0ba7ff ,
          ...
          setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
          setup_container.add_item(ui.Separator())
          setup_container.add_item(ui.TextDisplay(f"⏳ | Initializing Quick Setup!\n⏳ Checking VORTEXINF-bot's role position for optimal configuration...\n⏳ | Crafting and configuring the VORTEXINF Unstoppable Power role...\n⚠️ | Setup failed: HTTPException: {e}\nCheck Guild **Audit Logs**."))
          await setup_message .edit (view=setup_view)
          return 
        ...
        setup_container.add_item(ui.TextDisplay("# Antinuke Setup ⚙️"))
        setup_container.add_item(ui.Separator())
        setup_container.add_item(ui.TextDisplay("⏳ | Initializing Quick Setup!\n⏳ Checking VORTEXINF-bot's role position for optimal configuration...\n⏳ | Crafting and configuring the VORTEXINF Unstoppable Power role...\n⏳ Ensuring precise placement of the VORTEXINF Unstoppable Power role..."))
        await setup_message .edit (view=setup_view)
        try :
        ...
        modules_info = f"⚙️ **Modules Enabled**\n>>> ❌✅ **Anti Ban**\n❌✅ **Anti Kick**\n❌✅ **Anti Bot**\n❌✅ **Anti Channel Create**\n❌✅ **Anti Channel Delete**\n❌✅ **Anti Channel Update**\n❌✅ **Anti Everyone/Here**\n❌✅ **Anti Role Create**\n❌✅ **Anti Role Delete**\n❌✅ **Anti Role Update**\n❌✅ **Anti Member Update**\n❌✅ **Anti Guild Update**\n❌✅ **Anti Integration**\n❌✅ **Anti Webhook Create**\n❌✅ **Anti Webhook Delete**\n❌✅ **Anti Webhook Update**\n❌✅ **Anti Prune**\n **Auto Recovery**"
        ...
        # Footer
        footer_info = "Successfully Enabled Antinuke for this server | Powered by Neva Development"
