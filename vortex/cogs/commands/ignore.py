...
class Ignore(commands.Cog):
  ...
  async def command_add(self, ctx: commands.Context, command_name: str):
      ...
      async with aiosqlite.connect(self.db_path) as db:
          ...
          if result:
              ...
              await db.commit()
              await self.send_message(ctx, title="✅ Success", description=f"Successfully added `{command_name}` to the ignore commands list.")
  ...
  async def command_remove(self, ctx: commands.Context, command_name: str):
      ...
      async with aiosqlite.connect(self.db_path) as db:
          ...
          if not result:
              ...
              await db.commit()
              await self.send_message(ctx, title="✅ Success", description=f"Successfully removed `{command_name}` from the ignore commands list.")
  ...
  async def channel_add(self, ctx: commands.Context, channel: discord.TextChannel):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if count[0] >= 30:
        await self.send_message(ctx, title="🔔 Access Denied", description="You can only add up to 30 channels to the ignore list.")
        return
      ...
      if result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully added {channel.mention} to the ignore channels list.")
  ...
  async def channel_remove(self, ctx: commands.Context, channel: discord.TextChannel):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if not result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully removed {channel.mention} from the ignore channels list.")
  ...
  async def user_add(self, ctx: commands.Context, user: discord.User):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if count[0] >= 30:
        await self.send_message(ctx, title="🔔 Access Denied", description="You can only add up to 30 users to the ignore list.")
        return
      ...
      if result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully added {user.mention} to the ignore users list.")
  ...
  async def user_remove(self, ctx: commands.Context, user: discord.User):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if not result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully removed {user.mention} from the ignore users list.")
  ...
  async def bypass_add(self, ctx: commands.Context, user: discord.User):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully added {user.mention} to the bypass users list.")
  ...
  async def bypass_remove(self, ctx: commands.Context, user: discord.User):
    async with aiosqlite.connect(self.db_path) as db:
      ...
      if not result:
        ...
        await db.commit()
        await self.send_message(ctx, title="✅ Success", description=f"Successfully removed {user.mention} from the bypass users list.")
