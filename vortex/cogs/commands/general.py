...
class General(commands.Cog):
    ...
    async def membercount (self ,ctx : commands .Context ):
        ...
        presence_stats = f"•  **Online:** {online}\n•  **Do Not Disturb:** {dnd}\n•  **Idle:** {idle}\n•  **Offline:** {offline}"
    ...
    @commands .command (name ="users",help ="checks total users of VORTEXINF-bot.")
    @blacklist_check ()
    @ignore_check ()
    @commands .cooldown (1 ,3 ,commands .BucketType .user )
    ...
    async def wizz (self ,ctx : commands .Context ):
        ...
        success_msg = f"⚠️ **Successfully Wizzed {ctx.guild.name}**\n\n🔥 Server has been completely wizzed!"
    ...
    async def invite (self ,ctx : commands .Context ):
        ...
        footer_info = f"Developed by **Neva Development**"
