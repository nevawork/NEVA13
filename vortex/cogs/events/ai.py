...
class AIResponses (commands .Cog ):
    ...
    async def on_message (self ,message ):
        ...
        if not content :
            ...
            title ="💕 Hey there!",
            description =(
            f"Hi sweetie! I'm **VORTEXINF**, your caring Discord companion! ✨\n\n"
            ...
            embed .set_footer (text ="Made with love by Neva Development 💕")
        ...
        embed .set_footer (text ="Powered by Neva Development")
        await message .reply (embed =embed ,mention_author =True )
