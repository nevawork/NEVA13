...
class UnbanModal(ui.Modal):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            await self.user.send(f"✅ You have been Unbanned from **{self.author.guild.name}** by **{self.author}**. Reason: {reason}")
            dm_status = "Yes"
...
@Author: Aegis
    + Discord: Solcodez
    + Community: https://discord.strelix.xyz (Neva Development)
    + for any queries reach out Community or DM me.
"""
"""
: ! Aegis !
